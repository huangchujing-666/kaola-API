/**  版本信息模板在安装目录下，可自行修改。
* bms_kaola_rawitemproperty.cs
*
* 功 能： N/A
* 类 名： bms_kaola_rawitemproperty
*
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
...
{
	/// <summary>
	/// bms_kaola_rawitemproperty:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class bms_kaola_rawitemproperty
	{
		public bms_kaola_rawitemproperty()
		{}
		#region Model
		private long _id=0;
